...
export default function HomePage() {
  ...
  return (
    <div className="space-y-24">
      {/* Hero Section */}
      <section className="text-center space-y-8 animate-in fade-in slide-in-from-bottom-8 duration-1000 py-12">
        ...
        <div className="space-y-4">
          <h1 className="text-6xl md:text-8xl font-black tracking-tighter sm:text-7xl">
            ...
            Deploy{' '}
            <span className="text-primary tracking-widest uppercase">Edge</span>
            .
          </h1>
          <p className="text-xl md:text-2xl text-muted-foreground max-w-2xl mx-auto font-medium leading-relaxed">
            Experimental full-stack framework for Bun + Cloudflare Workers. Zero
        ...
        <div className="group relative rounded-3xl border bg-card/50 backdrop-blur-xl p-8 shadow-2xl hover:border-primary/50 transition-all duration-500 overflow-hidden">
          ...
          <ul className="space-y-4">
            <li>
              <Link
                href="/about"
                className="flex items-center justify-between group/link text-sm font-semibold text-primary hover:translate-x-1 transition-transform"
              >
                About Company{' '}
                <span className="group-hover/link:opacity-100 opacity-0 transition-opacity">
                  →
                </span>
              </Link>
            </li>
